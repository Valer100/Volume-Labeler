...
class App(tk.Tk):
    def set_theme(self):
        ...
        self.style.configure("StatusBarBd.TFrame", background = colors.bd_status_bar)
        self.style.configure("StatusBar.TFrame", background = colors.bg_status_bar)
        self.style.configure("StatusBar.TLabel", background = colors.bg_status_bar, foreground = colors.fg)
        self.style.configure("Description.TLabel", foreground = colors.fg_description)
        self.configure(background = colors.bg)
